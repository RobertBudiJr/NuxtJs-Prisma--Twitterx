...
<template>
  <nuxt-link to="#" class="flex items-center p-3 w-min rounded-full text-black hover:bg-gray-200 dark:hover:bg-dim-200 dark:text-white" :class="defaultTransition">
